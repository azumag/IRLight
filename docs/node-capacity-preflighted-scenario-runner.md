...
保存される schema-v1 snapshot は hostname、Docker endpoint、環境変数、credential、provider 情報を含みません。現在の項目は platform system / machine / kernel、logical CPU、total memory、Docker server version、Docker Compose version です。
