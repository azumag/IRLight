...
# memory.events counters are workload-cgroup specific and cumulative. A host
# diagnostic must never guess either the workload cgroup or the counter
# generation. Require both the current file and an operator-managed
# same-generation baseline explicitly.
