...
raw_log="$tmp_dir/continuity-restart.raw.log"
core_pid=""
...
echo "::error title=IRLight continuity restart smoke failure::stage=continuity-restart-quarantined; inner diagnostics withheld because this smoke carries generated ingest credentials and session material" >&2
exit "$status"
