...
class ContinuityRestartSmokeIsolationTest(unittest.TestCase):
    ...
    def test_compose_project_is_unique_per_run(self) -> None:
        ...
        self.assertIn(f"test_compose=({expected})", self.source)
    ...
    def test_temporary_material_is_private_and_run_scoped(self) -> None:
        ...
        self.assertIn('auth_cookie_jar="$tmp_dir/cookies.txt"', self.source)
        self.assertIn('override="$tmp_dir/continuity-restart.override.yml"', self.source)
